...
static const ConstraintSyntax changes_constraints[] =
{
    ...
    ConstraintSyntaxNewStringList("silence", CF_ANYSTRING, "Suppress alert messages for the listed change categories", SYNTAX_STATUS_NORMAL),
    ConstraintSyntaxNewNull()
};
...
static const ConstraintSyntax copy_from_constraints[] =
{
    ...
    ConstraintSyntaxNewOption("protocol_version", "1,classic,2,tls,3,cookie,4,filestream,5,leech2,latest", "CFEngine protocol version to use when connecting to the server. Default: undefined", SYNTAX_STATUS_NORMAL),
